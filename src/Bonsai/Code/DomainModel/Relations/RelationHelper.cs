...
public static class RelationHelper
{
    ...
    [
        new RelationBinding(PageType.Person, PageType.Person, [
            RelationType.Parent,
            RelationType.Child,
            RelationType.Spouse,
            RelationType.Friend,
        ...
        new RelationBinding(PageType.Person, PageType.Pet, [RelationType.Pet]),
        new RelationBinding(PageType.Pet, PageType.Person, [RelationType.Owner]),
        new RelationBinding(PageType.Person, PageType.Location, [RelationType.Location]),
        new RelationBinding(PageType.Location, PageType.Person, [RelationType.LocationInhabitant]),
        new RelationBinding(PageType.Person, PageType.Event, [RelationType.Event]),
        new RelationBinding(PageType.Event, PageType.Person, [RelationType.EventVisitor])
    ];
    ...
    {
        return relation is RelationType.Spouse
            or RelationType.Pet
